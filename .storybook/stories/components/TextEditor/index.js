    ...
    renderTableToolbar = () => {
        ...
        return (
            <div className={'toolbar'}>
                ...
                <button type={'button'} onClick={this.onInsertColumn} disabled={!isTable}>
                    {'Insert Column'}
                </button>
                <button type={'button'} onClick={this.onInsertRow} disabled={!isTable}>
                    {'Insert Row'}
                </button>
                <button type={'button'} onClick={this.onRemoveColumn} disabled={!isTable}>
                    {'Remove Column'}
                </button>
                <button type={'button'} onClick={this.onRemoveRow} disabled={!isTable}>
                    {'Remove Row'}
                </button>
                <button type={'button'} onClick={this.onRemoveTable} disabled={!isTable}>
                    {'Remove Table'}
                </button>
                <button type={'button'} onClick={this.onToggleHeaders} disabled={!isTable}>
                    {'Toggle Headers'}
                </button>
            </div>
        );
