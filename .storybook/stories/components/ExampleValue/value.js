...
const exampleValue = (
    <value>
        <document>
            <h2>Slate With Tables</h2>
            <p>The page demonstrates the slate-tables plugin.</p>

            <h3>Basic Tables</h3>
            <p>
                Simple tables can still contain block-level content. This page is intentionally not using other plugins,
                but you could easily embed lists, images, or any other block-level content in cells.
            </p>
            ...
            <h3>Headerless</h3>
            <p>
                Headerless tables can be used for aligning columns. One-row tables are always headerless, but you can
                use the Toggle Headers button to hide or show headers on any table.
            </p>
